...
internal static class GameFunctions
{
    ...
    public static unsafe delegate* unmanaged< nint, float, uint, nint, byte, void > pTerminateRound;
    ...
    public static void Initialize()
    {
        unsafe
        {
            ...
            pTerminateRound = (delegate* unmanaged< nint, float, uint, nint, byte, void >)NativeSignatures.Fetch("CGameRules::TerminateRound");
    ...
    public static void TerminateRound( nint gameRules, uint reason, float delay )
    {
        try
        {
            unsafe
            {
                pTerminateRound(gameRules, delay, reason, 0, 0);
            }
        }
        catch (Exception e)
        {
